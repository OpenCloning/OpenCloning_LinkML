...
class RecombinaseSourceId(AssemblySourceId):
    pass
...
@dataclass(repr=False)
class Recombinase(YAMLRoot):
    _inherited_slots: ClassVar[list[str]] = []

    class_class_uri: ClassVar[URIRef] = OPENCLONING_LINKML["Recombinase"]
    class_class_curie: ClassVar[str] = "opencloning_linkml:Recombinase"
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.site2_name is not None and not isinstance(self.site2_name, str):
            self.site2_name = str(self.site2_name)
...
class RecombinaseSource(AssemblySource):
    """
    Represents the source of a sequence that is generated by recombination using one or more recombinases
    """

    _inherited_slots: ClassVar[list[str]] = []

    class_class_uri: ClassVar[URIRef] = OPENCLONING_LINKML["RecombinaseSource"]
    class_class_curie: ClassVar[str] = "opencloning_linkml:RecombinaseSource"
    class_name: ClassVar[str] = "RecombinaseSource"
    class_model_uri: ClassVar[URIRef] = OPENCLONING_LINKML.RecombinaseSource
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, RecombinaseSourceId):
            self.id = RecombinaseSourceId(self.id)

        if self._is_empty(self.recombinases):
            self.MissingRequiredField("recombinases")
...
slots.recombinase__site1 = Slot(
    uri=OPENCLONING_LINKML.site1,
...
slots.recombinase__site2 = Slot(
    uri=OPENCLONING_LINKML.site2,
...
slots.recombinase__site1_name = Slot(
    uri=OPENCLONING_LINKML.site1_name,
    name="recombinase__site1_name",
    curie=OPENCLONING_LINKML.curie("site1_name"),
    model_uri=OPENCLONING_LINKML.recombinase__site1_name,
    domain=None,
    range=Optional[str],
)

slots.recombinase__site2_name = Slot(
    uri=OPENCLONING_LINKML.site2_name,
    name="recombinase__site2_name",
    curie=OPENCLONING_LINKML.curie("site2_name"),
    model_uri=OPENCLONING_LINKML.recombinase__site2_name,
    domain=None,
    range=Optional[str],
)

slots.recombinaseSource__recombinases = Slot(
    uri=OPENCLONING_LINKML.recombinases,
    name="recombinaseSource__recombinases",
    curie=OPENCLONING_LINKML.curie("recombinases"),
