...
--     * Slot: RecombinaseSource_id Description: Autocreated FK slot
...
--     * Slot: database_id Description: The id of an entity in a database
--     * Slot: id Description: A unique identifier for a thing
-- # Class: "Recombinase" Description: ""
--     * Slot: id Description:
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: site1 Description:
--     * Slot: site2 Description:
--     * Slot: site1_name Description:
--     * Slot: site2_name Description:
--     * Slot: RecombinaseSource_id Description: Autocreated FK slot
-- # Class: "RecombinaseSource" Description: "Represents the source of a sequence that is generated by recombination using one or more recombinases"
--     * Slot: reverse_reaction Description: Whether the reaction can happen in both directions (i.e. reverse or forward)
--     * Slot: circular Description: Whether the assembly is circular or not
--     * Slot: type Description: Designates the class
--     * Slot: output_name Description: Used to specify the name of the output sequence
--     * Slot: database_id Description: The id of an entity in a database
...
CREATE TABLE "RecombinaseSource" (
	reverse_reaction BOOLEAN NOT NULL,
	circular BOOLEAN,
	type TEXT,
	output_name TEXT,
	database_id INTEGER,
...
CREATE TABLE "Recombinase" (
	...
	PRIMARY KEY (id),
	FOREIGN KEY("RecombinaseSource_id") REFERENCES "RecombinaseSource" (id)
);
